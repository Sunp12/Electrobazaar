...
<%@ page import="in.electrobazaar.dao.impl.*,in.electrobazaar.dao.*,in.electrobazaar.pojo.*,javax.servlet.ServletOutputStream,java.io.*,java.util.*" %>
<!DOCTYPE html>
<html>
    <head>
            ...
            <div class="table-responsive ">
                <table class="table table-hover table-sm">
                    ...
                    <tbody >
                        ...
                        <%
                            List<ProductPojo> products = (List<ProductPojo>) session.getAttribute("products");
