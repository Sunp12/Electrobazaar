...
<%@page import="in.electrobazaar.utility.*,java.util.*" %>
<%@page import="in.electrobazaar.pojo.ProductPojo" %>
<%@page import="in.electrobazaar.dao.impl.ProductDaoImpl" %>
<%@page import="in.electrobazaar.dao.impl.*,in.electrobazaar.dao.*" %>
<%@page import="in.electrobazaar.pojo.*,javax.servlet.ServletOutputStream,java.io.*" %>
<!DOCTYPE html>
<html>
	<head>
			...
			<div class="row text-center">
				...
				<div class="col-sm-4">
					<div class="thumbnail mt-3 mb-3">
						<img
							src="./ShowImageServlet?pid=<%=prod.getProdId()%>"
							alt="Product"
							style="height: 150px; max-width: 180px"
							class="mt-3"
						/>
						<p class="productname"><%=prod.getProdName()%></p>
						<% /* JAva Code */ 
						...
						<p class="price">Rs <%=prod.getProdPrice()%></p>
						<form method="post">
							<% if(cartQty==0){ %>
							<button
								type="submit"
