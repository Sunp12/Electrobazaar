...
<%@ page import="in.electrobazaar.dao.impl.*,in.electrobazaar.pojo.*,in.electrobazaar.dao.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*" %> 
...
//            ProductPojo product = prod.getProductDetails(prodId);
