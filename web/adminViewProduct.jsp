...
<%@ page import="java.util.*, in.electrobazaar.pojo.*,in.electrobazaar.dao.*,in.electrobazaar.dao.impl.*,javax.servlet.*,java.io.*" %>
<!DOCTYPE html>
<html>
<head>
...
<body style="background-color: #E6F9E6;">
	...
	<div class="text-center h3 text-primary m-3">
            <%= 
